...
public interface CollectService {
     ...
     * @return
     */
    @Select("SELECT * FROM t_sys_user WHERE id=(SELECT u_id FROM t_sys_collect WHERE m_id=#{musicId})")
     ...
     * @return
     */
    @Select("SELECT * FROM t_sys_music WHERE id=(SELECT m_id FROM t_sys_collect WHERE u_id=#{userId})")
